...
if INPUT_1 == "calc":
    print(f'      passband edge : {Wp} Hz --> {wp} rad/s')
    print(f'      stopband edge : {Ws} Hz --> {ws} rad/s')
else:
...
print(f'      Kaiser    : {Nk}')
if (Nk % 2) != 0:
    print(f'                : Changed to {Nk+1} for TYPE 1 Filter')        
print(f'      Bellanger : {Nb}')
if (Nk % 2) != 0:
    print(f'                : Changed to {Nb+1} for TYPE 1 Filter')
print(f'      Herman    : {Nh}')
if (Nk % 2) != 0:
    print(f'                : Changed to {Nh+1} for TYPE 1 Filter')
print(f'                D_inf : {Dinf}')
print(f'                F     : {F}')
